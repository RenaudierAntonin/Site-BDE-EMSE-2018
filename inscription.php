...
<body>
	...
	<form class="inscription" action = "index.php" method = "post">
		<p>E-mail</p><input placeholder="E-mail" type="text" name="mail">
		...
		<p>Numéro de téléphone</p><input placeholder="Numéro de téléphone" type="text" name="numero_mobile"> <!-- utiliser un type specifique au numero de tel -->
