...
<body>
	...
	<form class="inscription" action = "index.php" method = "post">
		...
		<p>Confirmation du mot de passe</p><input type="password" name="mdp">
		<p>Numéro de téléphone</p><input type="text" name="numero_mobile"> <!-- utiliser un type specifique au numero de tel -->
