function initialisation(){
	...
	switch (lvl){
		...
		case 1: // chaque case represente un niveau, avec un nouveau terrain a chaque niveau
			...
			Monstres = [ { nb : 10, vitesse : 3, force : 1, vie : 300, valeurXP : 100, valeurMoney : 100, coordonnees : {x : depart.x, y : depart.y}, image : "Amaury_Francou" , attenteVague : 0 },
						 { nb : 10, vitesse : 3, force : 1, vie : 300, valeurXP : 100, valeurMoney : 100, coordonnees : {x : depart.x, y : depart.y}, image : "Francois_Herve", attenteVague : 0 },
						 { nb : 10, vitesse : 3, force : 1, vie : 300, valeurXP : 100, valeurMoney : 100, coordonnees : {x : depart.x, y : depart.y}, image : "Antoine_Perrin", attenteVague : 0 } ]; // tableau des monstres, chaque ligne corespond à une vague
