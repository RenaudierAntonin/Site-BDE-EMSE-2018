function initialisationTerrain(){
	...
	switch (lvl){
		...
		case 1: // chaque case represente un niveau, avec un nouveau terrain a chaque niveau
			...
			Monstres = [ { nb : 15, vitesse : 4, force : 1, vie : 80, valeurXP : 1, valeurMoney : 8, coordonnees : {x : depart.x, y : depart.y}, nom : "Amaury Francou" , attenteVague : 50 },
						 { nb : 5, vitesse : 10, force : 1, vie : 100, valeurXP : 2, valeurMoney : 8, coordonnees : {x : depart.x, y : depart.y}, nom : "Etienne Saby", attenteVague : 200 },
						 { nb : 10, vitesse : 3, force : 1, vie : 300, valeurXP : 2, valeurMoney : 8, coordonnees : {x : depart.x, y : depart.y}, nom : "Antoine Perrin", attenteVague : 200 },
						 { nb : 20, vitesse : 4, force : 1, vie : 300, valeurXP : 2, valeurMoney : 7, coordonnees : {x : depart.x, y : depart.y}, nom : "Axel Roc", attenteVague : 200 },
						 { nb : 10, vitesse : 4, force : 1, vie : 500, valeurXP : 3, valeurMoney : 10, coordonnees : {x : depart.x, y : depart.y}, nom : "Mathilde Bonnichon", attenteVague : 200 },
...
// attenteVague est le nb de frame entre la fin de la vague precedente et le debut de celle ci
		...
		case 2: 
			...
			Monstres = [ { nb : 10, vitesse : 3, force : 1, vie : 150, valeurXP : 1, valeurMoney : 9, coordonnees : {x : depart.x, y : depart.y}, nom : "Gabriel Chiche" , attenteVague : 50 },
						 ...
						 { nb : 2, vitesse : 2, force : 5, vie : 8000, valeurXP : 300, valeurMoney : 200, coordonnees : {x : depart.x, y : depart.y}, nom : "Francois Herve", attenteVague : 200 } ];
