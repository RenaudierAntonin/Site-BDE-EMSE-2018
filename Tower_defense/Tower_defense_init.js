function initialisation(){
	...
	switch (lvl){
		...
		case 1: // chaque case represente un niveau, avec un nouveau terrain a chaque niveau
			...
			Monstres = [ { nb : 15, vitesse : 3, force : 1, vie : 100, valeurXP : 100, valeurMoney : 5, coordonnees : {x : depart.x, y : depart.y}, nom : "Amaury Francou" , attenteVague : 50 },
						 { nb : 5, vitesse : 10, force : 1, vie : 200, valeurXP : 100, valeurMoney : 5, coordonnees : {x : depart.x, y : depart.y}, nom : "Etienne Saby", attenteVague : 200 },
						 { nb : 10, vitesse : 4, force : 1, vie : 400, valeurXP : 100, valeurMoney : 5, coordonnees : {x : depart.x, y : depart.y}, nom : "Antoine Perrin", attenteVague : 200 },
						 ...
						 { nb : 1, vitesse : 2, force : 1, vie : 10000, valeurXP : 300, valeurMoney : 200, coordonnees : {x : depart.x, y : depart.y}, nom : "Francois Herve", attenteVague : 200 } ]; // tableau des monstres, chaque ligne corespond à une vague
// attenteVague est le nb de frame entre la fin de la vague precedente et le debut de celle ci
		...
		case 2: 
			...
			depart = {x : (terrain.chemin.debut.i - terrain.chemin.parselles[0].x + 0.5) * Taille_Cases, y : (terrain.chemin.debut.j - terrain.chemin.parselles[0].y + 0.5) * Taille_Cases}; 
			Monstres = [ { nb : 15, vitesse : 3, force : 1, vie : 100, valeurXP : 200, valeurMoney : 2, coordonnees : {x : depart.x, y : depart.y}, nom : "Gabriel Chiche" , attenteVague : 50 },
						 { nb : 20, vitesse : 10, force : 1, vie : 300, valeurXP : 100, valeurMoney : 5, coordonnees : {x : depart.x, y : depart.y}, nom : "Etienne Saby", attenteVague : 200 },
						 { nb : 10, vitesse : 4, force : 1, vie : 400, valeurXP : 100, valeurMoney : 5, coordonnees : {x : depart.x, y : depart.y}, nom : "Antoine Perrin", attenteVague : 200 },
						 { nb : 20, vitesse : 4, force : 1, vie : 400, valeurXP : 100, valeurMoney : 5, coordonnees : {x : depart.x, y : depart.y}, nom : "Axel Roc", attenteVague : 200 },
