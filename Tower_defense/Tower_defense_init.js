function initialisation(){
	...
	switch (lvl){
		...
		case 1: // chaque case represente un niveau, avec un nouveau terrain a chaque niveau
			...
			Monstres = [ { nb : 10, vitesse : 3, force : 1, vie : 300, valeurXP : 100, valeurMoney : 100, coordonnees : {x : depart.x, y : depart.y}, nom : "Amaury Francou" , attenteVague : 0 },
						 { nb : 10, vitesse : 3, force : 1, vie : 300, valeurXP : 100, valeurMoney : 100, coordonnees : {x : depart.x, y : depart.y}, nom : "Francois Herve", attenteVague : 0 },
						 { nb : 10, vitesse : 3, force : 1, vie : 300, valeurXP : 100, valeurMoney : 100, coordonnees : {x : depart.x, y : depart.y}, nom : "Antoine Perrin", attenteVague : 0 } ]; // tableau des monstres, chaque ligne corespond à une vague
